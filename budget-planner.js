(function(){
  ...
  function ensure(){
    ...
    box.innerHTML=`<div class="finance-heading"><div><h3>Un budget clair. Des choix plus simples.</h3><div class="finance-note">Tes revenus, tes dépenses et la suite de tes projets. Montants en dollars canadiens.</div></div></div><div class="finance-controls"><button type="button" class="alt" data-action="previous" aria-label="Mois précédent">‹</button><input id="hpFinanceMonth" type="month" value="${month}" aria-label="Mois du budget"><button type="button" class="alt" data-action="next" aria-label="Mois suivant">›</button></div><div class="finance-tabs" role="tablist" aria-label="Mon budget"><button type="button" data-view="overview" role="tab" id="hpFinanceTabOverview" aria-controls="hpFinanceOverview">Mon bilan</button><button type="button" data-view="plan" role="tab" id="hpFinanceTabPlan" aria-controls="hpFinanceEditor">Mes montants</button><button type="button" data-view="calendar" role="tab" id="hpFinanceTabCalendar" aria-controls="hpFinanceCalendar">Mes dates</button></div><p id="hpFinanceStatus" class="finance-note" role="status" aria-live="polite">Chargement du budget…</p><details class="finance-load-options"><summary>Actualiser les données</summary><button type="button" class="alt" data-action="reload">Actualiser sans perdre ma saisie</button><button type="button" class="alt" data-action="replace">Revenir à la version enregistrée</button></details><button type="button" class="alt" data-action="retry" hidden>Réessayer le chargement</button><section id="hpFinanceScenario" class="finance-block finance-scenario" aria-labelledby="hpFinanceScenarioTitle" hidden></section><div id="hpFinanceOverview" role="tabpanel" aria-labelledby="hpFinanceTabOverview"></div><div id="hpFinanceEditor" role="tabpanel" aria-labelledby="hpFinanceTabPlan" hidden></div><div id="hpFinanceCalendar" role="tabpanel" aria-labelledby="hpFinanceTabCalendar" hidden></div>`;
