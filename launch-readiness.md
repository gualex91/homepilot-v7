...
Consulter le [suivi du 14 septembre](audit-suivi-20260914.md), l’[audit du 13 septembre](audit-20260913.md), sa [matrice des champs](audit-champs-20260913.csv) et le [protocole de cinq jours](protocole-testeurs-5-jours.md). Le lot courant obtient **271 tests JavaScript réussis, aucun échec et un test navigateur non exécuté**; les contrôles SQL des versions et de l’isolation réussissent, y compris le complément sur les équipements. La connexion sécurisée a réussi après l’autorisation du propriétaire. Le budget et les opérations ont été observés, mais une alerte native a ensuite bloqué le navigateur de contrôle. La recette connectée exhaustive reste partielle. Le correctif de saisie affiche désormais les erreurs dans le formulaire et conserve les valeurs. Quatre réponses 504 ont été relevées sur des chargements financiers secondaires; leur cause reste à diagnostiquer. Le propriétaire confirme son parcours de dépense; cela ne valide pas tous les appareils ni tous les champs. La vidéo avec voix française et mission en ouverture (2 min 09 s), ainsi que la fiche de cinq jours pour quatre à cinq testeurs, sont préparées. La [validation précédente](qa-validation-20260912.md) conserve les preuves de sauvegarde et de restauration. **Aucune campagne de cinq jours ni aucun lancement public ne sont activés.** Les sections ci-dessous conservent la chronologie et les décisions initiales.
