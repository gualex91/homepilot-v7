...
Consulter le [suivi du 14 septembre](audit-suivi-20260914.md), l’[audit du 13 septembre](audit-20260913.md), sa [matrice des champs](audit-champs-20260913.csv) et le [protocole de cinq jours](protocole-testeurs-5-jours.md). Le lot courant obtient 267 tests JavaScript réussis, aucun échec et un test navigateur non exécuté; les contrôles SQL des versions et de l’isolation réussissent, y compris le complément sur les équipements. La recette connectée exhaustive reste bloquée par le refus automatique de la nouvelle connexion. Le propriétaire confirme son parcours de dépense; cela ne valide pas tous les appareils ni tous les champs. La vidéo et la fiche de cinq jours pour quatre à cinq testeurs sont préparées. La [validation précédente](qa-validation-20260912.md) conserve les preuves de sauvegarde et de restauration. Aucun lancement public n’est validé. Les sections ci-dessous conservent la chronologie et les décisions initiales.
