...
export default async function handler(req,res){
  ...
  try{
    ...
    if(req.method==='GET'){
      const q=new URL(req.url,'https://homepilot.invalid').searchParams;
