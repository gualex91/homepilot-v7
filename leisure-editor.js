 ...
 function open(record,expectedOwner,mode='edit',taskCount){
  ...
  $('hpLeisureEditorForm').onsubmit=async e=>{
   ...
   try{
    ...
    window.hpAssetPayments?.invalidate();window.hpLoadLeisure?.();
